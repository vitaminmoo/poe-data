...
pub struct PassiveSkillMasteryGroupsRow {
    pub r#id: String,
    pub r#mastery_effects: Vec<PassiveSkillMasteryEffectsRef>,
    pub r#unknown24: bool,
    pub r#sound_effect: SoundEffectsRef,
    pub r#mastery_count_stat: StatsRef,
    pub r#art: PassiveSkillTreeMasteryArtRef,
}

#[derive(Debug, Clone, Copy, Hash, PartialEq, Eq, Ord, PartialOrd)]
pub struct PassiveSkillMasteryGroupsRef(pub usize);

impl Deref for PassiveSkillMasteryGroupsRef {
    type Target = PassiveSkillMasteryGroupsRow;
    fn deref(&self) -> &'static Self::Target {
        &TABLE_PassiveSkillMasteryGroups[self.0]
    }
}

impl PassiveSkillMasteryGroupsRef {
    pub fn new(index: usize) -> Self {
        Self(index)
    }
    pub fn as_static_ref(&self) -> &'static PassiveSkillMasteryGroupsRow {
        &TABLE_PassiveSkillMasteryGroups[self.0]
    }
    pub fn get(&self) -> &'static PassiveSkillMasteryGroupsRow {
        &TABLE_PassiveSkillMasteryGroups[self.0]
    }
...
mod test {
    ...
    #[test]
    fn get_all_rows() {
        for row in TABLE_PassiveSkillMasteryGroups.iter() {
            black_box(row);
        }
    }
}
