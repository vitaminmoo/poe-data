...
#[derive(Debug)]
pub struct SkillGemInfoRow {
    pub r#id: String,
    pub r#description: String,
    pub r#video_url1: String,
    pub r#skill_gems_key: SkillGemsRef,
    pub r#video_url2: String,
    pub r#characters_keys: Vec<CharactersRef>,
}

#[derive(Debug, Clone, Copy, Hash, PartialEq, Eq, Ord, PartialOrd)]
pub struct SkillGemInfoRef(pub usize);

impl Deref for SkillGemInfoRef {
    type Target = SkillGemInfoRow;
    fn deref(&self) -> &'static Self::Target {
        &TABLE_SkillGemInfo[self.0]
    }
}

impl SkillGemInfoRef {
    pub fn new(index: usize) -> Self {
        Self(index)
    }
    pub fn as_static_ref(&self) -> &'static SkillGemInfoRow {
        &TABLE_SkillGemInfo[self.0]
    }
    pub fn get(&self) -> &'static SkillGemInfoRow {
        &TABLE_SkillGemInfo[self.0]
    }
...
mod test {
    ...
    #[test]
    fn get_all_rows() {
        for row in TABLE_SkillGemInfo.iter() {
            black_box(row);
        }
    }
}
