...
#[derive(Debug)]
pub struct AlternateTreeArtRow {
    pub r#unknown0: i64,
    pub r#unknown16: i64,
    pub r#unknown32: i64,
    pub r#unknown48: i64,
...
pub struct AlternateTreeArtRef(pub usize);

impl Deref for AlternateTreeArtRef {
    type Target = AlternateTreeArtRow;
    fn deref(&self) -> &'static Self::Target {
        &TABLE_AlternateTreeArt[self.0]
    }
}

impl AlternateTreeArtRef {
    pub fn new(index: usize) -> Self {
        Self(index)
    }
    pub fn as_static_ref(&self) -> &'static AlternateTreeArtRow {
        &TABLE_AlternateTreeArt[self.0]
    }
    pub fn get(&self) -> &'static AlternateTreeArtRow {
        &TABLE_AlternateTreeArt[self.0]
    }
...
mod test {
    ...
    #[test]
    fn get_all_rows() {
        for row in TABLE_AlternateTreeArt.iter() {
            black_box(row);
        }
    }
}
