...
pub static TABLE_BlightCraftingRecipes: LazyLock<Vec<BlightCraftingRecipesRow>> =
    LazyLock::new(|| {
        let df = DAT_LOADER
            .write()
            .unwrap()
        ...
        df.rows_iter()
            .map(|row| BlightCraftingRecipesRow {
                ...
                r#blight_crafting_items: {
                    ...
                    values
                        .into_iter()
                        .map(|value| BlightCraftingItemsRef::new(value as usize))
                        .collect()
                },
            })
            .collect()
