...
pub static TABLE_MicrotransactionPeriodicCharacterEffectVariations: LazyLock<Vec<MicrotransactionPeriodicCharacterEffectVariationsRow>> = LazyLock::new(|| {
    let df = DAT_LOADER
        .write()
        .unwrap()
...
impl MicrotransactionPeriodicCharacterEffectVariationsRef {
    ...
    pub fn iter() -> impl Iterator<Item = Self> {
        TABLE_MicrotransactionPeriodicCharacterEffectVariations.iter().enumerate().map(|(i, _)| Self(i))
    }
    pub fn iter_with_refs() -> impl Iterator<Item = (Self, &'static MicrotransactionPeriodicCharacterEffectVariationsRow)> {
