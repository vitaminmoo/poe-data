...
pub static TABLE_MicrotransactionConditionalApparitionEvents: LazyLock<
    Vec<MicrotransactionConditionalApparitionEventsRow>,
> = LazyLock::new(|| {
    let df = DAT_LOADER
        .write()
        .unwrap()
...
impl MicrotransactionConditionalApparitionEventsRef {
    ...
    pub fn iter() -> impl Iterator<Item = Self> {
        TABLE_MicrotransactionConditionalApparitionEvents
            .iter()
            .enumerate()
            .map(|(i, _)| Self(i))
    }
    pub fn iter_with_refs() -> impl Iterator<
        Item = (
            Self,
            &'static MicrotransactionConditionalApparitionEventsRow,
        ),
    > {
        TABLE_MicrotransactionConditionalApparitionEvents
            .iter()
