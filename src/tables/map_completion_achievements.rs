...
pub static TABLE_MapCompletionAchievements: LazyLock<Vec<MapCompletionAchievementsRow>> =
    LazyLock::new(|| {
        let df = DAT_LOADER
            .write()
            .unwrap()
        ...
        df.rows_iter()
            .map(|row| MapCompletionAchievementsRow {
                ...
                r#map_stat_conditions_keys: {
                    ...
                    values
                        .into_iter()
                        .map(|value| MapStatConditionsRef::new(value as usize))
                        .collect()
                },
                r#stats_keys: {
                    // array_mutator column.array == true
                ...
                r#map_tier_achievements_keys: {
                    ...
                    values
                        .into_iter()
                        .map(|value| MapTierAchievementsRef::new(value as usize))
                        .collect()
                },
                r#unknown72: {
...
impl MapCompletionAchievementsRef {
    ...
    pub fn iter() -> impl Iterator<Item = Self> {
        TABLE_MapCompletionAchievements
            .iter()
            .enumerate()
            .map(|(i, _)| Self(i))
    }
