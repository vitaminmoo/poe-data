...
#[derive(Debug)]
pub struct GroundEffectTypesRow {
    pub r#id: String,
    pub r#unknown8: i32,
    pub r#unknown12: f32,
    pub r#unknown16: i64,
...
pub struct GroundEffectTypesRef(pub usize);

impl Deref for GroundEffectTypesRef {
    type Target = GroundEffectTypesRow;
    fn deref(&self) -> &'static Self::Target {
        &TABLE_GroundEffectTypes[self.0]
    }
}

impl GroundEffectTypesRef {
    pub fn new(index: usize) -> Self {
        Self(index)
    }
    pub fn as_static_ref(&self) -> &'static GroundEffectTypesRow {
        &TABLE_GroundEffectTypes[self.0]
    }
    pub fn get(&self) -> &'static GroundEffectTypesRow {
        &TABLE_GroundEffectTypes[self.0]
    }
...
mod test {
    ...
    #[test]
    fn get_all_rows() {
        for row in TABLE_GroundEffectTypes.iter() {
            black_box(row);
        }
    }
}
