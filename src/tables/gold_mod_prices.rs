    ...
    df.rows_iter()
        .map(|row| GoldModPricesRow {
            ...
            r#craftable_type: {
                ...
                let value = cell_bytes.get_i64_le();
                CraftableModTypesRef::new(value as usize)
            },
            r#unknown48: {
...
#[derive(Debug)]
pub struct GoldModPricesRow {
    pub r#mod: ModsRef,
    pub r#value: i32,
    pub r#base_price_percent: i32,
    pub r#unknown24: i32,
    pub r#unknown28: i32,
    pub r#craftable_type: CraftableModTypesRef,
    pub r#unknown48: Vec<i64>,
}

#[derive(Debug, Clone, Copy, Hash, PartialEq, Eq, Ord, PartialOrd)]
pub struct GoldModPricesRef(pub usize);

impl Deref for GoldModPricesRef {
    type Target = GoldModPricesRow;
    fn deref(&self) -> &'static Self::Target {
        &TABLE_GoldModPrices[self.0]
    }
}

impl GoldModPricesRef {
    pub fn new(index: usize) -> Self {
        Self(index)
    }
    pub fn as_static_ref(&self) -> &'static GoldModPricesRow {
        &TABLE_GoldModPrices[self.0]
    }
    pub fn get(&self) -> &'static GoldModPricesRow {
        &TABLE_GoldModPrices[self.0]
    }
...
mod test {
    ...
    #[test]
    fn get_all_rows() {
        for row in TABLE_GoldModPrices.iter() {
            black_box(row);
        }
    }
}
