...
pub static TABLE_ActiveSkillWeaponRequirement: LazyLock<Vec<ActiveSkillWeaponRequirementRow>> =
    LazyLock::new(|| {
        let df = DAT_LOADER
            .write()
            .unwrap()
        ...
        df.rows_iter()
            .map(|row| ActiveSkillWeaponRequirementRow {
                ...
                r#wieldable_classes: {
                    ...
                    values
                        .into_iter()
                        .map(|value| WieldableClassesRef::new(value as usize))
                        .collect()
                },
                r#string: {
...
impl ActiveSkillWeaponRequirementRef {
    ...
    pub fn iter() -> impl Iterator<Item = Self> {
        TABLE_ActiveSkillWeaponRequirement
            .iter()
            .enumerate()
            .map(|(i, _)| Self(i))
    }
